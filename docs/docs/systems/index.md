...
Cette section documente les systèmes moteur (client) utilisés dans le projet R-Type J.A.M.E.S. Chaque page décrit le rôle du système, les composants qu'il traite, son comportement et le fichier source associé.
