...
TEST_F(ButtonClickSystemTest, DetectsHoverWhenMouseInsideBounds) {
    Com::Transform transform{
        100.0f, 100.0f, 0.0f, 1.0f, Com::Transform::CENTER};
    ...
    ButtonClickSystem(
        reg, game_world, hit_boxes, clickables, drawables, transforms);
...
TEST_F(ButtonClickSystemTest, ScalesHitBoxWithTransformWhenEnabled) {
    Com::Transform transform{
        300.0f, 200.0f, 0.0f, 2.0f, Com::Transform::CENTER};
...
TEST_F(ButtonClickSystemTest, DoesNotScaleHitBoxWhenDisabled) {
    Com::Transform transform{
        300.0f, 200.0f, 0.0f, 3.0f, Com::Transform::CENTER};
...
TEST_F(ButtonClickSystemTest, TriggersOnClickCallbackWhenReleased) {
    ...
    Com::Transform transform{
        400.0f, 300.0f, 0.0f, 1.0f, Com::Transform::CENTER};
...
TEST_F(ButtonClickSystemTest, ClickStateResetWhenMouseNotPressed) {
    Com::Transform transform{
        250.0f, 200.0f, 0.0f, 1.0f, Com::Transform::CENTER};
