...
sf::Vector2f GetOffsetForOrigin(const Com::Transform &transform,
    sf::Vector2f hit_box) {
    ...
    {Com::Transform::CENTER, sf::Vector2f(hit_box.x / 2.0f, hit_box.y / 2.0f)},
    {Com::Transform::RIGHT_CENTER, sf::Vector2f(hit_box.x, hit_box.y / 2.0f)},
    {Com::Transform::BOTTOM_LEFT, sf::Vector2f(0.0f, hit_box.y)},
    {Com::Transform::BOTTOM_CENTER, sf::Vector2f(hit_box.x / 2.0f, hit_box.y)},
...
sf::Vector2f GetOffsetFromAnimatedTransform(const Com::Transform &transform,
    ...
    return GetOffsetFromTransform(transform, sf::Vector2f(
        static_cast<float>(animated_sprite.frameWidth),
