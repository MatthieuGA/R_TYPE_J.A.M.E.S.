...
bool IsCollidingFromOffset(const Com::Transform &trans_a,
    ...
    const Com::HitBox &hb_b, Engine::Graphics::Vector2f off_a, Engine::Graphics::Vector2f off_b) {
    ...
    Engine::Graphics::Vector2f scal_hb_a =
        Engine::Graphics::Vector2f(hb_a.width * scale_x_a, hb_a.height * scale_y_a);
    Engine::Graphics::Vector2f scal_hb_b =
        Engine::Graphics::Vector2f(hb_b.width * scale_x_b, hb_b.height * scale_y_b);
