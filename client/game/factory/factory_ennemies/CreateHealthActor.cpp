...
void FactoryActors::CreateHealthActor(
    ...
    animated_sprite.AddAnimation(
        "Hit", "ennemies/powerups/PowerUp_Heal.png", 16, 16, 2, 0.1f, false);
    animated_sprite.AddAnimation("Death",
        "ennemies/powerups/Death_Health_PU.png", 16, 16, 4, 0.05f, false);
    animated_sprite.AddAnimation("Attack",
        "ennemies/powerups/PowerUp_Heal.png", 16, 16, 2, 0.1f, false);
