...
class zipper_iterator {
 public:
    ...
    template <class...>
    friend class indexed_zipper_iterator;

 private:
    zipper_iterator(
        iterator_tuple containers, std::size_t max, std::size_t idx = 0);
 ...
 public:
    ...
    friend bool operator==(
        zipper_iterator const &a, zipper_iterator const &b) {
        return a._idx == b._idx && a._max == b._max &&
